...
-- 插入示例经营范围数据
INSERT INTO `business_scope` (`id`, `no`, `good_type`, `good_name`, `good_model`, `good_remark`, `public_price`, `create_time`, `update_time`, `create_by`, `update_by`, `is_deleted`) VALUES 
('BS001', 'BS2024001', '废金属', '废铁', '普通废铁', '含杂质不超过5%', 2.50, NOW(), NOW(), 'system', 'system', '0'),
('BS002', 'BS2024002', '废金属', '废铜', '电线废铜', '纯度不低于90%', 15.00, NOW(), NOW(), 'system', 'system', '0'),
('BS003', 'BS2024003', '废金属', '废铝', '铝型材废料', '无严重氧化', 8.00, NOW(), NOW(), 'system', 'system', '0'),
('BS004', 'BS2024004', '废纸', '废纸', '混合废纸', '含水率不超过15%', 0.80, NOW(), NOW(), 'system', 'system', '0'),
('BS005', 'BS2024005', '废纸', '废纸', '纸板废料', '无严重污染', 1.20, NOW(), NOW(), 'system', 'system', '0'),
('BS006', 'BS2024006', '废塑料', '废塑料', 'PET瓶', '无油污，无标签', 1.50, NOW(), NOW(), 'system', 'system', '0'),
('BS007', 'BS2024007', '废塑料', '废塑料', 'PP料', '无杂质，无污染', 2.80, NOW(), NOW(), 'system', 'system', '0'),
('BS008', 'BS2024008', '废玻璃', '废玻璃', '透明玻璃', '无破损，无杂质', 0.30, NOW(), NOW(), 'system', 'system', '0'); 