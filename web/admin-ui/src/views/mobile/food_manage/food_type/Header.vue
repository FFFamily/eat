  ...
  <div class="header">
    <el-popover placement="bottom" trigger="click" :width="200">
      ...
      <el-menu class="small-menu" @select="handleMenuSelect">
        <el-menu-item index="AddFood">添加食物类别</el-menu-item>
        <!-- 这里可以添加其他菜单项 -->
      </el-menu>
    </el-popover>
  </div>
   <!-- 使用 v-model 绑定 dialogVisible -->
   <FoodTypeAddDialog v-model="dialogVisible"  class="add" @close="handleDialogClose" />
</template>
...
import FoodTypeAddDialog from './FoodTypeAddDialog.vue';
